...
export default function AIPoweredSolutionsPage() {
  ...
  return (
    <div className="min-h-screen">
     ...
     <div className="text-2xl font-bold text-orange-600 mb-1">Custom AI Model Development</div>
                          <div className="text-sm text-muted-foreground">Purpose-built models for your needs</div>
                        </div>
                        <div className="text-center p-4 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-lg">
                          <div className="text-2xl font-bold text-green-600 mb-1">Predictive Analytics & Insights</div>
                        ...
                        <div className="text-center p-4 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-lg">
                          <div className="text-2xl font-bold text-purple-600 mb-1">Smart Automation & Workflows</div>
